...
export const Index = () => {
    ...
    const { handleLoginMerchant } = useLogic();

    const onSubmit = async () => {
        setLoading(true);
        const res: any = await handleLoginMerchant(inputData);
        if (res?.status) {
            ...
            localStorage.setItem('_UID', res.data.user_id);
    ...
    return (
        <>
            ...
            <div className="flex justify-center items-center m-auto w-[26rem] -mt-[19rem]">
            ...
            <div className="flex justify-center items-center">
                ...
                >
                    ...
                    <div className='flex justify-between pt-4 gap-24'>
                        ...
                        <p onClick={() => navigate("/merchant/sign-up")}>Lupa Password ?</p>
                    </div>
