...
import { Button, Image, VStack, Input, FormControl, FormLabel, useToast } from "@chakra-ui/react"
...
export const Index = () => {
    ...
    const { handleUpdateAvatarClient, handleUpdateProfileClient } = useLogic();
        ...
        <>
            <div className="flex justify-center items-center">
                <Image
                    boxSize='100px'
                    objectFit='cover'
                    src={file ? file : profileInfo?.profile_pict}
